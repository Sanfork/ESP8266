...
INT32 pull_server_param(SIGN_DATA_TYPE_E signDataType,SERVER_PARAM_TYPE_E pullType,AUTH_INFO_S *info)
{
    ...
    if(strlen(info->errCode))//if(NULL != info->errCode)
    {
...
{
    aliyun_iot_common_set_log_level(DEBUG_IOT_LOG);//INFO_IOT_LOG);
